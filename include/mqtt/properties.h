 ...
 */
    ...
    inline string get<string>(const property &prop) {
        return (!prop.c_struct().value.data.data) ? string()
                                                  : string(prop.c_struct().value.data.data,
                                                           prop.c_struct().value.data.len);
    }
    ...
    inline string_pair get<string_pair>(const property &prop) {
        ...
        string value = (!prop.c_struct().value.value.data) ? string()
                                                           : string(prop.c_struct().value.value.data,
                                                                    prop.c_struct().value.value.len);
 ...
 */
    ...
    public:
        ...
        size_t byte_length() const {
            return (size_t)
            ::MQTTProperties_len(const_cast<MQTTProperties *>(&props_));
        }
